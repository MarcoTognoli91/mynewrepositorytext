...
def BelowGradeSimple():
    ...
    Excel_Table = load_workbook("BelowGrade.xlsx")
    WindowData = Excel_Table.get_sheet_by_name("Data")# Here we extract the data from the sheet called "Data"
